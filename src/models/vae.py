from keras.layers import Flatten, Input, Dense, Conv2D, MaxPooling2D, UpSampling2D, Lambda, Reshape, Conv2DTranspose, AveragePooling2D
...
def vae_model_fmnist(latent_dim=128):
...
def vae_model_svhn(latent_dim=128):
